...
void cadastrar_candidato(){	
	...
	relatorio_pessoa = fopen("..\\font\\relatorio_pessoa.txt", "a");//abre arquivo tipo texto para inclusão de dados
...
int valida_curso(Candidato cadastro){
	...
	relatorio_curso = fopen("..\\font\\relatorio_curso.txt", "r");//abre o arquivo relatorio_curso.txt tipo texto para çeitura
...
int valida_estado(Candidato cadastro){
	...
	relatorio_estado = fopen("..\\font\\relatorio_estado.txt", "r");//abre o arquivo relatorio_estado.txt tipo texto para çeitura
